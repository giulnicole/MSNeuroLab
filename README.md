...
### Methodologies 
- Correlation analysis (workflow for correlation matriz and heatmap)
- Pre-Post analsysis (delta change analysis, test pre-post, analysis of covariance)
- Regression models (linear model, logistic model)
